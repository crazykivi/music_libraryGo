...
## Ошибка проекта:
1. В конфиг стоит выносить все переменные данные, в том числе и адрес сервиса
2. У группы может быть много песен и хранить данные в куче в одной таблице - это нарушение нормализации БД
3. Не стоит забывать про индексы при создании БД
4. Дату релиза все же стоит хранить в соответствующем типе, а не в строке
5. Интеграция с внешним апи сделана не по приложенному сваггеру
6. Обновление не реализовано
7. Фильтрации нет
8. Пагинация по куплетам не реализована
9. Нет возможности настраивать уровень логирования
